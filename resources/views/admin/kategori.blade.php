                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                <img src="{{ $category->icon_path ? asset('storage/' . $category->icon_path) : 'https://via.placeholder.com/48?text=Icon' }}" class="rounded-circle border" alt="{{ $category->name }}" width="48" height="48">
                                <div>
